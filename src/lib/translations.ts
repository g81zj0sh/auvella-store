...
const DICT: Record<string, string[]> = {
  ...
  "Built for the day, not the photo.": ["Conçu pour la journée, pas pour la photo.", "Diseñado para el día, no para la foto.", "Gemacht für den Tag, nicht für das Foto.", "Pensato per la giornata, non per la foto.", "Gemaakt voor de dag, niet voor de foto.", "Feito para o dia, não para a foto.", "مصمم ليومكِ، لا للصورة.", "为一整天而造，而非为照片。", "写真のためでなく、一日のために。"],
  "Shapewear, bras and lounge built to hold where it helps and stay put all day.": [
    "Lingerie sculptante, soutiens-gorge et lounge conçus pour maintenir là où il le faut et rester en place toute la journée.",
    "Fajas, sujetadores y prendas de estar diseñados para sujetar donde hace falta y no moverse en todo el día.",
    "Shapewear, BHs und Loungewear, die dort halten, wo es zählt – und den ganzen Tag sitzen bleiben.",
    "Shapewear, reggiseni e lounge pensati per sostenere dove serve e restare al loro posto tutto il giorno.",
    "Shapewear, bh's en loungewear die houden waar het helpt en de hele dag blijven zitten.",
    "Modeladores, sutiãs e peças de estar feitos para segurar onde importa e ficar no lugar o dia todo.",
    "ملابس تنسيق القوام وحمالات الصدر وملابس الاسترخاء — تثبّت حيث يلزم وتبقى مكانها طوال اليوم.",
    "塑身衣、内衣与家居服 — 该收的地方收住，整天不移位。",
    "必要なところだけ支えて、一日中ずれない。シェイプウェア、ブラ、ラウンジウェア。",
  ],
